...
This is the first release of the Model Parameters Pipeline package, implementing transformations according to the Model Parameters specification developed by Big Life Lab.

### Features

- **Core Pipeline Functionality**: Sequential data transformation pipeline supporting multiple transformation steps
