...
2.  [`run_model_pipeline()`](https://big-life-lab.github.io/model-parameters-pipeline/reference/run_model_pipeline.md):
    Apply transformations to data and retrieve the output of the model
    pipeline. The output is the results of the last transformation step.
    Depending on the step, this may include multiple columns.
